...
func GetFunctions() []*FunctionEntry {
	return []*FunctionEntry{
		...
		},
		{
			...
			ReturnType: []JpType{JpObject},
			Note:       "decodes an x.509 certificate to object. you may also use this in conjunction with `base64_decode` jmespath function to decode a base64-encoded certificate",
		},
	}
}
